...
use CmsCommon\Form\View\Helper\FormMonthSelect as BaseFormMonthSelect,
    CmsCommon\View\Helper\Decorator\DecoratorProviderInterface;

class FormMonthSelect extends BaseFormMonthSelect implements DecoratorProviderInterface
{
    /**
     * @var array
     */
