...
namespace CmsTwbs\Datagrid\View\Helper;

use Zend\I18n\View\Helper\AbstractTranslatorHelper,
    CmsDatagrid\Column,
    CmsDatagrid\Column\Action\AbstractAction;

/**
 * View Helper
 */
class Row extends AbstractTranslatorHelper
{
    /**
     * @param  array          $row
     * @param  array          $cols
    ...
    public function __invoke(
        ...
        if (true === $hasMassActions) {
            $return .= '<td><input type="checkbox" name="massActionSelected[]" value="' .
                $row['idConcated'] . '" /></td>';
        }
